...
ADD FOREIGN KEY("Visiter_id") REFERENCES "Visiter"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Itinerary_Item"
ADD FOREIGN KEY("group_id") REFERENCES "Itinerary_Group"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ADD FOREIGN KEY("session_id") REFERENCES "AI_Chat_Session"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Visiter_AI_Preference"
ADD FOREIGN KEY("Visiter_id") REFERENCES "Visiter"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "AI_Itinerary_Draft"
ADD FOREIGN KEY("session_id") REFERENCES "AI_Chat_Session"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ADD FOREIGN KEY("location_id") REFERENCES "Base_Location"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Recommended_Itinerary_Translations"
ADD FOREIGN KEY("recommended_group_id") REFERENCES "Recommended_Itinerary_Group"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Recommended_Itinerary_Item"
ADD FOREIGN KEY("recommended_group_id") REFERENCES "Recommended_Itinerary_Group"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Itinerary_Item_Review"
ADD FOREIGN KEY("itinerary_item_id") REFERENCES "Itinerary_Item"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Itinerary_Item_Review"
ADD FOREIGN KEY("Visiter_id") REFERENCES "Visiter"("id")
ON UPDATE NO ACTION ON DELETE NO ACTION;
